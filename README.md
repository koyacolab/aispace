...
- ainf.ipynb for image patch inferencing
- great.py contains adapted Trainer. Wandb callback is used for generating L1,L2 metrics for more reliable training process to prevent overfitting and put them to wandb.ai.
- great_dataset.py contain 
******************************************************************************************
